...
const featuredProducts = [
  ...
  },
  {
    ...
    description: 'BioProst Premium es un suplemento nutricional para adultos presentado en un frasco de 60 tabletas y formulado con diferentes ingredientes nutricionales y botánicos.',
