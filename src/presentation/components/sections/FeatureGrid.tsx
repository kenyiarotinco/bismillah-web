        ...
        <FadeUp>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-white font-display mb-4">
              Beneficios <span className="text-emerald-400">Clínicos</span>
            </h2>
          ...
          {benefits.map((benefit, index) => (
            <FadeUp key={index} delay={index * 0.1}>
              <HoverGlowCard className="p-8 bg-[#0b0f19] flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-teal-600/5 border border-emerald-500/20 flex items-center justify-center mb-6">
